...
class MainActivity2 : AppCompatActivity(), ChannelAdapter.OnItemRangeChangeListener {
...
//    private val city = arrayOf("重庆", "深圳", "汕头", "东莞", "佛山", "江门", "湛江", "惠州", "中山", "揭阳", "韶关", "茂名", "肇庆", "梅州", "汕尾", "河源", "云浮", "四川")
    ...
    private val select = arrayOf("要闻", "体育", "新时代", "汽车")
    private val recommend = arrayOf("娱乐", "军事", "文化", "视频")
    private val city = arrayOf("重庆", "深圳", "汕头", "东莞", "佛山")
...
//
//        city.mapTo(cityList) {
//            ChannelBean(it, 1, R.layout.adapter_channel, false)
//        }
//
...
//        mAdapter = ChannelAdapter(this, mList, recommendList, cityList)
        mAdapter = ChannelAdapter(this, mList, recommendList)
        mAdapter!!.fixSize = 1
