...
class ChannelAdapter(
    ...
    var recommendList: ArrayList<ChannelBean>,
//    var cityList: ArrayList<ChannelBean>
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            R.layout.adapter_channel -> ChannelHolder(view) //item
            R.layout.adapter_more_channel -> MoreChannelHolder(view) //更多频道
            R.layout.adapter_tab -> TabHolder(view) //tab
            else -> TitleHolder(view) //标题
        }
    }
...
//        val params = holder.indicator.layoutParams as LinearLayout.LayoutParams
        //计算蓝色线条位置
//        if (mLeft == -1) {
//            holder.recommend.viewTreeObserver.addOnPreDrawListener(object :
